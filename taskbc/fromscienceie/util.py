...
def parseXML(fpath="/home/sagnik/data/scienceie/devdata/dev/xmls/S2352179115300041.xml"):
    '''
...
def readAnn(xmlfolder = "/home/sagnik/data/scienceie/devdata/dev/anns/",textfolder="/home/sagnik/data/scienceie/devdata/dev/txts/"):
    '''
    ...
    flist = os.listdir(xmlfolder)
    for f in flist:
        f_anno = open(os.path.join(xmlfolder, f), "rU")
